...
export const domainExpertise: DomainExpertise[] = [
  {
    ...
    experience: '10+ years',
    projects: ['React/Angular SPAs', 'RESTful APIs', 'Cloud Integration', 'Progressive Web Apps', 'Database Integration'],
    color: '#00BCD4',
    icon: 'web',
    proficiency: 88,
    isFavorite: true,
  ...
  },
  {
    ...
    projects: [
      ...
      'Highly Realistic Real-time Rendering',
    ],
    color: '#F44336',
    icon: 'medical',
    proficiency: 92,
...

  {
    ...
    category: 'Technology',
    experience: '2+ years',
    projects: ['Aerial Videography', 'Data Collection', 'Flight Planning'],
    color: '#FF9800',
    icon: 'drone',
    proficiency: 60,
  },
